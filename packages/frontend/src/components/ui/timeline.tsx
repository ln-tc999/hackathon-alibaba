        ...
        >
            <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
                ...
                <p className="text-slate-400 text-sm md:text-base max-w-sm">
                    Five simple steps to visual content automation.
                </p>
            </div>
            ...
            <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
                {data.map((item, index) => (
                    ...
                    >
                        <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                            <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-[#0a0f1c] flex items-center justify-center">
                                <div className="h-4 w-4 rounded-full bg-slate-800 border border-slate-700 p-2" />
                            </div>
                ...
                >
                    <motion.div
                        ...
                        className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-b from-[#ffffff] via-[#93c5fd] to-[#60a5fa] rounded-full"
                    />
                </div>
            </div>
        </div>
