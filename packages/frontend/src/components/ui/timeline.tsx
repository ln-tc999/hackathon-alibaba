            ...
            <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
                {data.map((item, index) => (
                    ...
                    >
                        <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                            <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center">
                ...
                >
                    <motion.div
                        ...
                        className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-b from-blue-300 via-blue-500 to-blue-600 rounded-full"
                    />
                </div>
            </div>
        </div>
