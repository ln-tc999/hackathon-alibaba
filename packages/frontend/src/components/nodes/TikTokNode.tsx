    ...
    try {
      ...
      if (data.authUrl || data.redirectUrl) {
        ...
        const pollInterval = setInterval(async () => {
          ...
          try {
            if (popup.closed) {
              console.log('[TikTok] Popup closed, continuing to poll...');
            }
          } catch (e) {
